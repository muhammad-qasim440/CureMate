...
class OnBoardingFirstView extends ConsumerWidget {
        ...
        body: Stack(
          ...
          children: [
            CustomLinearGradientContainerWidget(
              ...
              left: ScreenUtil.scaleHeight(context, -140),
              ...
              child: Column(
                children: [
                  ...
                  CustomButtonWidget(
                    ...
                    onPressed: () {
                      AppNavigation.push(const OnBoardingSecondView());
                    },
                  ),
                  14.height,
                  CustomButtonWidget(
